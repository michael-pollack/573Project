...
"""
python fine_tune_abstractive.py \
  --train_file data/PLOS/cleaned/train_plos_combined.json \
  --val_file data/PLOS/cleaned/validation-00000-of-00001_clean.json \
  --output_dir ./pegasus_xsum \
  --num_train_epochs 3 \
...
python fine_tune_abstractive.py \
  --train_file data/Elife/cleaned/train-00000-of-00001_clean.json \
  --val_file data/Elife/cleaned/validation-00000-of-00001_clean.json \
  --output_dir ./pegasus_xsum \
  --num_train_epochs 3 \
  --per_device_train_batch_size 2 \
  --per_device_eval_batch_size 2 \
